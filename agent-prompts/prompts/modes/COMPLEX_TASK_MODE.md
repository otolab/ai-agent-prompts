...
- **メモで計画や気づきを記録**: `note_taking`を有効にする（推奨）
- **技術的な判断が必要な作業**: `tech_notes`を有効にする
- **調査フェーズ**: `specification_research`を有効にする
- **実装フェーズ**: `coding_practice`を有効にする
- **Issue番号が関連**: `issue_tracking`を有効にする
